Feature: Questionnaire
  ...
  Scenario: student answer all questions and validate
    ...
    Then user "paul" validate "Quest1" and get "4" points


  Scenario: teacher gets answer of student
    When Teacher "steve" gets notes from "paul" of "Quest1"
    Then return note is "4"
